...
# === Assets ===
ALLOWED_UNDERLYINGS = {"SPY", "QQQ", "VOO", "DIA", "IWM", "AAPL", "MSFT", "GOOGL", "AMZN", "NVDA", "TSLA", "META"}
ALLOWED_EQUITY_SYMBOLS = {"SPY", "QQQ", "VOO", "DIA", "IWM", "AAPL", "MSFT", "GOOGL", "AMZN", "NVDA", "TSLA", "META"}
ALLOW_EQUITIES = True
ALLOW_OPTIONS = True
ALLOW_CRYPTO = False
ALLOW_FOREX = False
