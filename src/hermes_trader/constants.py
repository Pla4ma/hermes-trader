...
MAX_SINGLE_TRADE_LOSS_USD = 10.00
ABSOLUTE_SINGLE_TRADE_LOSS_CAP_USD = 3.00
ABSOLUTE_OPTION_LOSS_CAP_USD = 50.00
MAX_DAILY_LOSS_USD = 20.00
MAX_WEEKLY_LOSS_USD = 10.00
MAX_MONTHLY_LOSS_USD = 20.00
MIN_CASH_RESERVE_USD = 5.00

# === Trade Limits ===
MAX_OPEN_POSITIONS = 5  # FIX: was 3, too tight for 0DTE + swing
MAX_NEW_TRADES_PER_DAY = 3
MAX_NEW_TRADES_PER_WEEK = 20  # FIX: was 10, too tight for 0DTE (3/day × 5 days = 15)
MAX_CONSECUTIVE_LOSSES = 3
MAX_EQUITY_ORDER_NOTIONAL_USD = 500.00  # FIX: was 15, too tight for actual trades
MAX_POSITION_NOTIONAL_USD = 500.00  # Raised for 0DTE SPY options ($200+ per contract)
...
MAX_CONTRACTS = 5  # FIX: was 2, allows proper position sizing
...
MAX_OPTION_PREMIUM_USD = 15.00
MAX_OPTION_SPREAD_WIDTH_USD = 2.00
MAX_CONTRACTS = 5  # FIX: was 2 (duplicate, consolidated)
